...
<TR BGCOLOR=#948DCF>
  <TD>
    <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0 WIDTH=330>
  	  <TR BGCOLOR="#FFFFFF">
        <TD ALIGN="center">
        	<form name="frm" method="post" action="pass_search">
	 <div class="tab_container" style="margin-top:10px;width:477;height:80;">
         ...
         <div class="inputBox" style="width:300px;left: 44px;bottom: 27px;">
                    <input type="text" name="email" maxlength=20 style="width:300px;" required onkeyup="this.setAttribute('value', this.value);"  value="" >
