...
<script>
	function id_check(){
		...
		if(frm.b_email.value==""){
			alert("メール を 入力してください");
			frm.b_email.focus();
			return;
		}
...
<TR BGCOLOR=#948DCF>
  <TD>
    <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0 WIDTH=330>
  	  <TR BGCOLOR="#FFFFFF">
        <TD ALIGN="center">
        	<form name="frm" method="post" action="b_pass_search">
	 <div class="tab_container" style="margin-top:10px;width:477;height:80;">
         ...
         <div class="inputBox" style="width:300px;left: 44px;bottom: 27px;">
                    <input type="text" name="b_email" maxlength=20 style="width:300px;" required onkeyup="this.setAttribute('value', this.value);"  value="" >
	...
	<script>
		alert("臨時暗証番号は123456789aです。|n 新しいパスワードに変更してください。");
		location.href="/Member/login";
	</script>
