...
<body>
<form action="member_write" method="get" id="form1">
<div id="d1">
 <font size="6">
...
<br>
  ...
  <br>
 <div align="center">
  <input type="submit" class="button" value="同意します"  style="WIDTH: 95pt; HEIGHT: 30pt; font-size : 16px" >
  <input type="reset" class="cansel" value="同意しません" style="WIDTH: 95pt; HEIGHT: 30pt; font-size : 16px" >
 </div>
   <br>
</div>
