...
<TR BGCOLOR=#948DCF>
  <TD>
    <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0 WIDTH=330>
  	  <TR BGCOLOR="#FFFFFF">
        <TD ALIGN="center">
        	<form name="frm" method="post" action="id_search">
	 <div class="tab_container" style="margin-top:10px;width:477;height:80;">
         <div class="box" style="top:115px;border:none;width:400px;left:111.5;" >
                    <div class="inputBox" style="width:300px;marign-top:100px;left: 44px;">
                      <input type="text" name="name" maxlength=16 style="width:300px;" required onkeyup="this.setAttribute('value', this.value);"  value="${ name }" >
         ...
         <div class="inputBox" style="width:300px;left: 44px;bottom: 27px;">
                    <input type="text" name="tel" maxlength=16 style="width:300px;" required onkeyup="this.setAttribute('value', this.value);"  value="" >
