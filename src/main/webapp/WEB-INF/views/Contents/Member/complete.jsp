  ...
  <head>
    ...
    <script src="http://code.jquery.com/jquery-1.9.1.js"></script>
        <script type="text/javascript">
            ...
            //해당 태그에 아래 내용을 출력
            $("p.countdown").html("<b><font color='black' size='150pt'>"
            + count + "秒後 ログインページに 移動します");
                //0초면 초기화 후 이동되는 사이트
                if (count == 0) {
    ...
    .sa-icon.sa-success.animate::after {-webkit-animation: rotatePlaceholder 4.45s ease-in; animation: rotatePlaceholder 4.45s ease-in;}
    ...
    .animateSuccessTip {-webkit-animation: animateSuccessTip 0.95s; animation: animateSuccessTip 0.95s;}
    .animateSuccessLong {-webkit-animation: animateSuccessLong 0.95s; animation: animateSuccessLong 0.95s;}
...
<body>
  ...
  <center><font size="6">ログインしてください</center>
  <center><font size="6"><p class="countdown"></p></center>
