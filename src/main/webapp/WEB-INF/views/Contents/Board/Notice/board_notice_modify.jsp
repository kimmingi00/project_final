...
<div class="notice">
     ...
     <form method="post" name="notice" action="board_modify_pro?idx=${board.idx}&page=${page}"> <!--    -->
	  ...
	  <table border="0" style="margin-top:30px;width:90%;margin-left:10px">
       ...
       <tr>
        ...
        <tr>
         ...
         <td><input type="text" size="60" name="title" style="text-align:center;width:400px;" value="${board.title}"></td>
       </tr>
       <tr>
         <td><font size="3" color="#000000" class="alert">内容</font></td>
         <td><textarea wrap="physical" rows="30" name="contents" cols="100" style="border-radius:24px;text-align:center;width:90%;height:300px">${board.contents}</textarea></td>
       </tr>
